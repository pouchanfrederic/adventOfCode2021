...
public class adventOfCode3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //Puis faut le transforcer en décilal et multiplier le résultat pour avoir powerConsumption
//        int powerConsumption = gammaRate * epsilonRate;
        ...
        for(int z =0; z < nombreDeUn.length; z++){
            if(nombreDeUn[z] > nombreDeZero[z]){gammaRate[z] = 1; epsilonRate[z] = 0;}
            else{gammaRate[z] = 0; epsilonRate[z] = 1;}
        }
        System.out.println("Coucou");
        //Faut transformer gamma et epsilon en décimal et les multiplier
    }
}
